package com.fun.driven.development.fun.unified.payments.api.config.timezone;

import com.fun.driven.development.fun.unified.payments.api.FunUnifiedPaymentsApiApp;
import com.fun.driven.development.fun.unified.payments.api.repository.timezone.DateTimeWrapper;
import com.fun.driven.development.fun.unified.payments.api.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM fun_date_time_wrapper where id=%d", fieldName, id);
    }
