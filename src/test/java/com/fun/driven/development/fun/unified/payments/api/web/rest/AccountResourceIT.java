...
import com.fun.driven.development.fun.unified.payments.api.repository.AuthorityRepository;
import com.fun.driven.development.fun.unified.payments.api.repository.UserRepository;
import com.fun.driven.development.fun.unified.payments.api.security.AuthoritiesConstants;
import com.fun.driven.development.fun.unified.payments.api.service.UserService;
import com.fun.driven.development.fun.unified.payments.api.service.dto.PasswordChangeDTO;
import com.fun.driven.development.fun.unified.payments.api.service.dto.UserDTO;
import com.fun.driven.development.fun.unified.payments.api.web.rest.vm.KeyAndPasswordVM;
import com.fun.driven.development.fun.unified.payments.api.web.rest.vm.ManagedUserVM;
...
import static com.fun.driven.development.fun.unified.payments.api.web.rest.AccountResourceIT.TEST_USER_LOGIN;
